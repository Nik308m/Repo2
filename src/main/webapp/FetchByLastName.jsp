...
<body>
    <form id="fetchForm" action="/fetchByLname"  method="get">
        <label for="lname">Fetch Details By Last Name:</label>
    ...
    <div class="button-container">
        <button onclick="myFunction()">Go to Search by First Name</button>
    ...
    <script>
    	 ...
    	 document.getElementById('fetchForm').addEventListener('submit', function (event) {
             ...
             const lname = document.getElementById('lname').value;
              ...
              let myurl='/fetchByLname?lname='+lname;
             fetch(myurl , {
                 method: 'GET'
             })
